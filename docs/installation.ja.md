...
!!! warning "Python 3.9 サポート終了のお知らせ"
    RDEToolKit v1.6.0 からは Python 3.9 のサポートが削除されました。Python 3.9 をご利用の場合は、Python 3.10 以上へアップグレードするか、RDEToolKit v1.5.x 系を使用してください。

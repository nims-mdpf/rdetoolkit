...
| ------- | ------------ | ----------- | ------- |
| v1.6.0  | 2026-01-30   | **BREAKING**: Python 3.9 support dropped (minimum 3.10+) / `pytz` removed | [v1.6.0](#v160-2026-01-30) |
...
- Removed `pytz` and `types-pytz` dependencies; migrated all timezone handling to `datetime.timezone.utc` ([#375](https://github.com/nims-mdpf/rdetoolkit/issues/375))

...
def skip_exception_context(exception_type: type[Exception], logger: logging.Logger | None = None, enabled: bool = False) -> contextlib.AbstractContextManager[dict[str, str | None]]: ...

"""MultiDataTile-mode planning handler for the unified Runner."""
...
class MultiDataTileModeHandler:
    ...
    Runner. Divided-directory and policy compatibility arrives in Session I6.
    """

    kind = ModeKind.multidatatile

    def create_tiles(self, context: PlanningContext) -> Iterable[TilePlan]:
        """Create MultiDataTile-mode tile plans.

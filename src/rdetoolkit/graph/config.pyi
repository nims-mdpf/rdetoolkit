...
def determine_titles(*, title: str | None, name: str | None) -> tuple[str | None, str]: ...
def determine_formats(html: bool, return_fig: bool) -> list[str]: ...
def normalize_axis_limits(limits: tuple[float | None, float | None] | None) -> tuple[float, float] | None: ...
